    ...
    if user_main_messages.get('waiting_for_user_name'):
        ...
        if ipv6_subnet:
            ...
            duration_buttons = [
                ...
                InlineKeyboardButton("3 месяц", callback_data=f"duration_1m_{user_name}_noipv6"),
                InlineKeyboardButton("6 месяц", callback_data=f"duration_1m_{user_name}_noipv6"),
                InlineKeyboardButton("12 месяц", callback_data=f"duration_1m_{user_name}_noipv6"),
...
async def connect_user(callback: types.CallbackQuery):
    ...
    duration_buttons = [
        ...
        InlineKeyboardButton("3 месяц", callback_data=f"duration_1m_{client_name}_{ipv6_flag}"),
        InlineKeyboardButton("6 месяц", callback_data=f"duration_1m_{client_name}_{ipv6_flag}"),
        InlineKeyboardButton("12 месяц", callback_data=f"duration_1m_{client_name}_{ipv6_flag}"),
    ...
    if action == 'block':
        ...
        if user_traffic.get('limit') and user_traffic.get('used') >= user_traffic['limit']:
            ...
            duration_buttons = [
                ...
                InlineKeyboardButton("3 месяц", callback_data=f"unblock_duration_1m_{username}"),
                InlineKeyboardButton("6 месяц", callback_data=f"unblock_duration_1m_{username}"),
                InlineKeyboardButton("12 месяц", callback_data=f"unblock_duration_1m_{username}"),
